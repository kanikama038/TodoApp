        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LoggedInedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LoggedOutedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Users_RevieweeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_RevieweeId",
                table: "Users",
                column: "RevieweeId",
                unique: true,
                filter: "[RevieweeId] IS NOT NULL");
        }
